    ...
    init: function() {
      ...
      if (run) {
        ...
        if ((object.options.iconDesktop) && (!touchDevice) || ((object.options.iconTouch) && (touchDevice))) {
          ...
          icon.data('tooltipsterContent', tooltipsterContent).append(object.options.icon).insertAfter($this);
      ...
      if (typeof options === 'string') {
        ...
        $t.each(function() {
          ...
          case 'destroy':
            ...
            $(this).attr('title', $t.data('tooltipsterContent')).removeData('plugin_tooltipster').removeData('tooltipsterContent').removeData('tooltipsterIcon').off('.tooltipster');
            break;
